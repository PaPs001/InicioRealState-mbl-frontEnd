...
export function LeadDetailScreen({
  ...
  const [previewImage, setPreviewImage] =
    useState<FollowingImagePreview | null>(null);
  const [isAppointmentModalVisible, setIsAppointmentModalVisible] =
    useState(false);
  const [isFollowingModalVisible, setIsFollowingModalVisible] = useState(false);
  const [isNextActionModalVisible, setIsNextActionModalVisible] =
    useState(false);
    ...
    <SafeAreaView edges={["left", "right", "bottom"]} style={styles.safeArea}>
        ...
        <View style={styles.rowBlock}>
          <View style={styles.informationContainer}>
            ...
            <View style={styles.tableInformation}>
              {" "}
              ## aqui comienza el bloque de informacion del usuario
              <View
                style={[styles.lineInformation, styles.lineInformationNoBor]}
              >
              ...
              <View
                style={[styles.lineInformation, styles.lineInformationEdge]}
              >
                <View style={styles.lineInformationInterior}>
                  {lead.email ? (
                    <Text
                  ...
                  <View style={styles.actionTextContainer}>
                    <View>
                      ...
                      <Text style={styles.actionDateText}>
                        {formatDateFollowing(lead.nextActionAt)}
                      </Text>
                      <Text style={styles.actionAdvisorText}>
                        Asesor: {lead.assignedAgentName}
                      </Text>
                    </View>
                  </View>
                </>
          ...
          ##esto se enviara componente externo se mantendra una funcionalidad
          relativa para obtener los datos rapidamente
          {/*<View style={[styles.informationContainer]}>
          ...
          <View style={styles.informationContainer}>
            ...
            {isLoadingFollowings ? (
              ...
              latestFollowings?.map((following, Index) => {
                ...
                return (
                  <View key={following.id} style={styles.timelineItem}>
      ...
      <View style={{ paddingHorizontal: 12 }}>
        <View style={styles.bottomButtons}>
          ...
          <Pressable
            style={styles.seeFollowingsButton}
