    ...
    >
      ...
      <View style={styles.propertyInfo}>
        ...
        <View style={styles.rawDataBlock}>
          <RawInfo label="Operacion" value={property.listingType === 'sale' ? 'Venta' : property.listingType === 'rent' ? 'Renta' : undefined} />
          <RawInfo label="Tipo" value={property.propertyType} />
          <RawInfo label="Vista" value={property.view} />
          <RawInfo label="Amueblado" value={property.furnishedLabel} />
          <RawInfo label="Panel solar" value={property.solarPanelLabel} />
        </View>
        ...
        <View style={styles.rawDataBlock}>
          <RawInfo label="Amenidades" value={property.tags.join(', ')} />
          <RawInfo label="Maps" value={property.locationUrl ? 'Disponible' : undefined} />
          <RawInfo label="Drive" value={property.googleDriveImages ? 'Disponible' : undefined} />
          <RawInfo label="Descripcion" value={property.description} />
        </View>
