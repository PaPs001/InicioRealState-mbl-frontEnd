...
import { getOwnerWelcomeRegisterParams } from '@/lib/services/register-owner-verification'
import { registerOwnerWelcomeStyles } from './register-owner-welcome.styles'
...
export default function RegisterOwnerWelcomeScreen() {
  ...
  const handleContinue = () => {
    router.push({
      pathname: '/register-owner-profile' as never,
      params: getOwnerWelcomeRegisterParams({
        clientType: 'owner',
        ownerAccess: '1',
