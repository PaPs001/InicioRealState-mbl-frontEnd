    ...
    return (
      ...
      >
        <View style={[styles.imageContainer, { backgroundColor: theme.background }]}>
          ...
          <TouchableOpacity 
            style={[styles.favoriteButton, favorite && styles.favoriteButtonActive, !favorite && { backgroundColor: theme.surface }]}
      ...
      <View style={styles.filterTabs}>
        <TouchableOpacity 
          style={[
            ...
            filter === 'all' && [styles.filterTabActive, { backgroundColor: theme.accent, borderColor: theme.accent }]
          ]}
          onPress={() => setFilter('all')}
        >
          <Text style={[styles.filterTabText, { color: theme.textSecondary }, filter === 'all' && styles.filterTabTextActive]}>
            Todos
          </Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[
            styles.filterTab, 
            { backgroundColor: theme.surface, borderColor: theme.border },
            filter === 'sale' && [styles.filterTabActive, { backgroundColor: theme.accent, borderColor: theme.accent }]
          ]}
          onPress={() => setFilter('sale')}
        >
          <Text style={[styles.filterTabText, { color: theme.textSecondary }, filter === 'sale' && styles.filterTabTextActive]}>
            Venta
          </Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[
            styles.filterTab, 
            { backgroundColor: theme.surface, borderColor: theme.border },
            filter === 'rent' && [styles.filterTabActive, { backgroundColor: theme.accent, borderColor: theme.accent }]
          ]}
          onPress={() => setFilter('rent')}
        >
          <Text style={[styles.filterTabText, { color: theme.textSecondary }, filter === 'rent' && styles.filterTabTextActive]}>
            Renta
          </Text>
        </TouchableOpacity>
      </View>
